...
parser.add_argument("folder", nargs="?", default="", help="Folder name in your Dropbox")
parser.add_argument(
    "rootdir",
    nargs="?",
    default="~/Dropbox/Apps/Joplin/",
...
def list_all_files(dbx):
    res = dbx.files_list_folder("", recursive=True, include_deleted=True)
